...
// import {executeGetAuthor, executeGetBookSeries, executeGetCategory, executeUpdateBookSeries} from "../api/endPoints";
...
//     }
//
//     // const setBookSeriesEpisode = async () => {
...
//         }
//         try {
//             const data = await executeUpdateBookSeries(category,authorName,validEpisode(episode), bookType, description, price, title, seriesName, imageFile, audioFile, pdfFile);
